...
Never commit, hardcode, or embed API keys, tokens, passwords, service credentials, or other secrets in source. Use environment variables or an approved secret store.
